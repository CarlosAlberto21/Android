...
public class MainActivity extends AppCompatActivity {
    ...
    public void Eliminar (View v){
        ...
        if (!codigo.isEmpty()){
            ...
            if(cantidad == 1){
                Toast.makeText(this, "Articulo eliminado exitosanente", Toast.LENGTH_SHORT).show();
    ...
    public void Modifica(View v){
        AdminSQLiteOpenHelper admin = new AdminSQLiteOpenHelper(this, "aadministracion", null, 1);
        SQLiteDatabase Basedatabase = admin.getWritableDatabase();
        ...
        if(!codigo.isEmpty() && !descripcion.isEmpty() && !precio.isEmpty()){
            ...
            Basedatabase.close();
            if (cantidad == 1){
                Toast.makeText(this, "El articulo se encontro correctamente", Toast.LENGTH_SHORT).show();
            }else{
